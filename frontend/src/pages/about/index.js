    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/kopf8/foodgram" className={styles.textLink}>Github repo</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/kopf8" className={styles.textLink}>Кирсанова Мария</a>
            </p>
          </div>
        </aside>
      </div>
